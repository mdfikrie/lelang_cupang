        ...
        <div class="page-inner">
            <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    <form action="{{url('lelangan/update')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label>Judul</label>
                                    <input type="text" class="form-control" name="id" value="{{$lelangan->id}}" hidden>
                                    <input type="text" class="form-control" name="judul" value="{{$lelangan->judul}}">
                                    @error('judul')
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="datepicker" name="tanggal" value="{{$lelangan->tgl_close}}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="timepicker" name="jam" value="{{$lelangan->jam_close}}">
                                                <div class="input-group-append">
                                                    <span class="input-group-text">
                                ...
                                <div class="input-file input-file-image">
                                    <img class="img-upload-preview" width="450" src="{{asset('gambar/'.$lelangan->gambar)}}" alt="preview">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="deskripsi" id="summernote">{{$lelangan->deskripsi}}</textarea>
                                </div>
                                @error('desskripsi')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
