				...
				@csrf
					<div class="login-form">
						...
						<div class="form-group form-action-d-flex mb-3">
							<button type="submit" class="btn btn-secondary col-md-12 float-right mt-3 mt-sm-0 fw-bold">Login</button>
						</div>
                        <div class="login-account">
							<span class="msg">Apakah anda belum punya akun?</span>
							<a href="/register" id="show-signup" class="link">Register</a><br>
							<a href="/forgot-password" id="show-signup" class="link">Forgot Password?</a>
						</div>
					</div>
				</form>
			</div>
