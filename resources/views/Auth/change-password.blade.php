	...
	<div class="wrapper wrapper-login wrapper-login-full p-0">
		...
		<div class="login-aside w-50 d-flex align-items-center justify-content-center bg-white">
			<div class="container container-login container-transparent animated fadeIn">
				...
				<form action="{{Route('konf-change-password',['email'=>$user->email,'token'=>$user->token])}}" method="POST">
				@csrf
					<div class="login-form">
						<div class="form-group">
                            <label for="password" class="placeholder"><b>Password Baru</b></label>
						...
						<div class="form-group">
							<label for="konf_password" class="placeholder"><b>Konfirmasi Password</b></label>
							<input name="konf_password" type="text" class="form-control">
                            @error('konf_password')
							<div class="text-danger">{{ $message }}</div>
							@enderror
						</div>
						<div class="form-group form-action-d-flex mb-3">
							<button type="submit" class="btn btn-secondary col-md-12 float-right mt-3 mt-sm-0 fw-bold">Konfirmasi</button>
						</div>
					</div>
					</div>
				</form>
